...
bool IsThereThisNeedleInThisHaystack(char *Haystack, char *Needle, int TextSize, int NeedleSize);
...
int main() {
	...
	*/
	...
	IsHere = IsThereThisNeedleInThisHaystack(Text, Needle, TextSize, NeedleSize);
